...
ab_CFLAGS = -I/usr/local/apache2/openssl/include
ab_LDFLAGS = -L/usr/local/apache2/openssl/lib -lssl -lcrypto -lrt -lcrypt -lpthread -ldl
...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /usr/local/lib/libaprutil-1.la -lexpat /usr/local/lib/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS =
AP_CLEAN_SRCLIB_DIRS =
abs_srcdir = /usr/local/apache2/httpd-2.4.16
